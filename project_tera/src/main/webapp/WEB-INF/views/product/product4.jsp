...
<head>
    ...
    <script src="../js/product/product4.js"></script>
    <style>
    .dropdown_sub_2_1{
	display:none;
               ...
               <div class="dropdown">
     	       ...
     	       <div class="photo"></div>
     	       	<div class="photo dropdown_subC"></div>
         			...
         			<div class="dropdown_sub_2_4">강관</div>
            	</div>
            </div>
        </div>
    </div>
    <div class="title_1">
      ...
      <div class="inner_case">
    	<div class="product_link">
    		...
    		<a href="." class="product_box_check">강관</a>
    	</div>
    </div>
   <div class="inner_case">
   		<div class="product">
   			<div class="img_4"></div> 
   			<div class="text5">
   			<div class="name_round">강관</div>
   			<hr class="gray_hr"/>
   			<div>강관산업의 선두주자, 최고 품질의 배관용, 구조용강관, 각형강관, 칼라강관을 비롯하여 스테인레스강관과 자동차부품용 강관생산으로 철강산업과 경제발전의 원동력이 되어왔습니다.
최신의 용접설비와 도장설비 그리고 고부가가치강관 제품으로 고객중심의 기업으로 자리매김하고자 합니다.</div>
   		</div>
   		</div>
   </div>
    <div class="bottom">
