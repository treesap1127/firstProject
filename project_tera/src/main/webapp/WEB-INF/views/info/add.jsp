...
<body>
	...
	<div class="title_1">
		<div class="inner_case">
			<div class="sub_text2">자료실 등록</div>
		</div>
	</div>
	<div class="inner_case" style="padding-bottom: 10rem;">
		<form method="post" enctype="multipart/form-data">
			...
			<div class="add_info">
				<label>자료 내용</label>
				<textarea rows="20" cols="113" name="dataInfo" id="summernote"></textarea>
			</div>
			<input type="hidden" name="id" class="id"
				value="${sessionScope.partner.id}" />

			<div>
				<label>자료파일:<span id="add_image"
					class="btn btn-outline-primary btn-sm">추가</span></label> <input
					type="file" name="infoFile" class="form-control file">
			</div>
