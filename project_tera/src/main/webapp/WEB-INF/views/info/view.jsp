...
<body>
   <div class="login_back">
            ...
            <div class="menu">
               <div class="dropdown">
   		        ...
   		        <div class="dropdown_sub_3">
   		           	 ...
   		           	 <div class="dropdown_sub_3_3">자료실</div>
    ...
    <div class="title_1">
        <div class="inner_case">
            <div class="sub_text2">자료실</div>
            <div class="sub_text1">(주)테라금속의 <span style="color: #336699; font-weight: 700;">자료실</span> 입니다.</div>
        </div>
    </div>
    ...
    <div class="inner_case">
        ...
        <div class="title_sub">
            등록일 <span class="value">${item.dataDate}</span> 등록자 <span class="value">${item.id}</span> 조회수 <span class="value">${item.dataCount}</span>
        </div>
        <div class="info">${item.dataInfo}</div>
        
        <c:if test="${item.multfile==null||item.multfile.size()<1}">
 				<li>등록 된 파일이 없습니다</li>
 			</c:if>
 		<c:forEach var="file" items="${item.multfile}">
 			<!-- <li><img src="/upload/${file.UUID}_${file.filename}"/></li> -->
 			<div style="display:flex" style="color:black;">파일명: ${file.filename}&nbsp;&nbsp; <a href="download/${file.code}" class="btn btn-sm btn-outline-dark">다운로드</a></div>
 		</c:forEach>
