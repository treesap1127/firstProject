...
<body>
	...
	<div class="title_1">
		<div class="inner_case">
			<div class="sub_text2">자료실 수정</div>
		</div>
	</div>
	<div class="inner_case" style="padding-bottom: 10rem;">
		<form method="post" enctype="multipart/form-data">
			<div class="form-floating">
				<div class="formName">자료 제목</div>
				<input type="text" name="dataName"
					class="form-control" placeholder="자료제목" value="${item.dataName}"> <label
					style="padding: 55px 1.25rem;">제목:</label>
			</div>

			<div class="add_info">
				<label>자료 내용</label>
				<textarea rows="20" cols="113" name="dataInfo" id="summernote">${item.dataInfo}</textarea>
			</div>
		...
		<div>
 			<ul>
				...
				<label>제품이미지:
					...
					<input type="file" name="infoFile" class="form-control">
					</div>
			</div>
			<div class="add_button">
				<button class="end_button">수정</button>
				<a href="../../info/" class="back_button">뒤로가기</a>
			</div>
		</form>
	</div>
	<div class="bottom">
