                ...
                <tbody class="table_body">
                    <c:forEach var="item" items="${list}">
                        ...
                        <tr>
                            <!--  여기서 내용을 담아줌! -->
                            <td>${item.data}</td>
                            <td class="black"><a href="view/${item.data}">${item.dataName}</a></td>
                            <td class="black"><a href="view/${item.data}">${item.id}</a></td>
                            <td>${item.dataDate}</td>
                            <td>${item.dataCount}</td>
                            <td class="deleteUpdate"><a href="delete/${item.data}" class="btn btn-sm btn-danger">삭제</a> 
    												<a href="update/${item.data}" class="btn btn-sm btn-warning">변경</a></td>
                        </tr>
