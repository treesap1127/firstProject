...
<body>
	...
	<div class="title_1">
		<div class="inner_case">
			<div class="sub_text2">자주 묻는 질문 수정</div>
		</div>
	</div>
		...
		<form method="post" enctype="multipart/form-data">
			<div class="form-floating">
				...
				<input type="text" name="fnqName"
					class="form-control" value="${item.fnqName}"> <label
					style="padding: 55px 1.25rem;">제목:</label>
			</div>

			<div class="add_info">
				<label>자주 묻는 질문 내용</label>
				<textarea rows="20" cols="113" name="fnqInfo" id="summernote">${item.fnqName}</textarea>
			</div>
			<input type="hidden" name="id" class="id"
				value="${sessionScope.partner.id}" />
			<div class="add_button">
				<button class="end_button">수정</button>
				<a href="../../fnq/" class="back_button">뒤로가기</a>
			</div>
		</form>
	</div>
	<div class="bottom">
