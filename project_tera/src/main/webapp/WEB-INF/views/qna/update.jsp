...
<div class="lock">  
	<div class="title_1">
		<div class="inner_case">
			<div class="sub_text2">Q&A 수정</div>
		</div>
	</div>
		...
		<form method="post" enctype="multipart/form-data">
			<div class="form-floating">
				...
				<input type="text" name="qnaName"
					class="form-control" value="${item.qnaName}"> <label
					style="padding: 55px 1.25rem;">제목:</label>
			</div>

			<div class="add_info">
				<label>Q&A 내용</label>
				<textarea rows="20" cols="113" name="qnaInfo" id="summernote">${item.qnaInfo}</textarea>
			</div>
			<input type="hidden" name="id" class="id"
				value="${sessionScope.partner.id}" />
			<div class="add_button">
				<button class="end_button">수정</button>
				<a href="../../qna/" class="back_button">뒤로가기</a>
			</div>
		</form>
	</div>
</div>
<div class="lock_case">
	<div class="lock_text">
		...
		<button type="button" id="lockdown" class="btn btn-primary">입력 </button>
		</form>
	</div>
