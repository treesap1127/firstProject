...
<body>
    ...
    <div class="main_photo_back">
        ...
        <div class="main_text_2">아이디 정보 수정</div>
    </div>
    
    <div class="title_1">
        <div class="inner_case">
            <div class="sub_text2">아이디 정보 수정</div>
            <div class="sub_text1">(주)테라금속의 <span style="color: #336699; font-weight: 700;">아이디 정보 수정</span> 입니다.</div>
        </div>
    </div>
                      ...
                      <div class="search_move_1">
                           <select name="search" class="form-select control">
                              ...
                              <option value="1" ${pager.search==1?'selected':''}>아이디</option>
                               <option value="2" ${pager.search==2?'selected':''}>직원코드</option>
                                <option value="3" ${pager.search==3?'selected':''}>등급</option>
                         </select>
                     </div>
        ...
        <div class="inner_case">
            <table border="1" class="table_all" >
                    ...
                    <c:forEach var="item" items="${list}">
                        ...
                        <tr>
                            ...
                            <td class="deleteUpdate">
                           		<a href="update/${item.id}"class="btn btn-sm btn-warning">비밀번호 변경</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    						 	<a href="delete/${item.id}" class="btn btn-sm btn-danger">삭제</a> 
    						</td>
                        </tr>
                ...
                <tfoot class="table_foot">
                    <tr>
                    	<td><a href="../" class="btn btn-sm btn-primary">뒤로가기</a></td>
                        <td colspan="2">
                        ...
                        <td><a href="../login/signup/" class="btn btn-sm btn-primary">회원가입</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    </tr>
                </tfoot>
            </table>
        </div>
