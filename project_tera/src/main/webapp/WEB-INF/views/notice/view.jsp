...
<head>
    ...
    <link rel="stylesheet" href="../../resources/css/notice/notice_view.css">
...
<body>
   <div class="login_back">
    ...
    <div class="inner_case">
        ...
        <div class="title_sub">
            등록일 <span class="value">${item.noticeDate}</span> 등록자 <span class="value">${item.id}</span> 조회수 <span class="value">${item.noticeCount}</span>
        </div>
