...
<head>
    ...
    $(function(){
    	...
    	let grade=$(".grade_1").val();
    	sessionGrade="${sessionScope.partner.grade}";
    	if(sessionGrade==0){
        	$(".grade_1").children(".black").addClass("alert_2");
        	$(".grade_1").children(".black").children("a").attr("href", ".")
        	}
    	if(sessionGrade>=2){
...
<body>
            ...
            <div class="menu">
               <div class="dropdown">
   		        ...
   		        <div class="dropdown_sub_3">
   	        		 ...
   	        		 <div class="dropdown_sub_3_1">공지사항</div>
    ...
    <div class="title_1">
        <div class="inner_case" >
            <div class="sub_text2">공지사항</div>
            <div class="sub_text1">(주)테라금속의 <span style="color: #336699; font-weight: 700;">공지사항</span> 입니다.</div>
        </div>
    </div>
    <div class="search">
        <div class="inner_case">
                ...
                <tbody class="table_body">
                    <c:forEach var="item" items="${list}">
                        <tr class="grade_${item.grade}">
                            <td>${item.notice}</td>
                            <td class="black"><a href="view/${item.notice}">${item.noticeName}</a><input class="grade" style="display: none" value="${item.grade}" /></td>
                            <td class="black"><a href="view/${item.notice}">${item.id}</a><input class="grade" style="display: none" value="${item.grade}" /></td>
                            <td>${item.noticeDate}</td>
                            <td>${item.noticeCount}</td>
                            <td class="deleteUpdate"><a href="delete/${item.notice}" class="btn btn-sm btn-danger">삭제</a> 
    												<a href="update/${item.notice}" class="btn btn-sm btn-warning">변경</a></td>
                        </tr>
                    </c:forEach>
